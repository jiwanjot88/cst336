...
//Displays the search reults in a table
function displayResults(){
    ...
    if(isset($items)) {
        ...
        foreach($items as $item){
            ...
            //Display table row w/Add button for the submitting form
            echo '<tr>';
            echo "<td><img src='$itemImage'></td>";
            echo "<td><h4>$itemName</h4></td>";
            echo "<td><h4>$$itemPrice</h4></td>";
            
            //Create 'hidden' fields to sent item data via POST
            echo "<form method='post'>";
            ...
            //If so, this item was just added to the cart. Dislplay different button
