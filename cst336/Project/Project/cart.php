			...
			<div class="col-md-4">
				<form method="post" action="cart.php?action=add&productId=<?php echo $row["productId"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
						...
						<input type="hidden" name="hidden_name" value="<?php echo $row["productDescription"]; ?>" />
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="cart.php?action=delete&productId=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
